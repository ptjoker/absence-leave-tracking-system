    ...
    try {
      const response = await fetch('http://localhost:3000/api/register', {
        ...
        body: JSON.stringify({
          ...
          cell_number: form.cellNumber ,// TODO: add a cell number field to the form later
